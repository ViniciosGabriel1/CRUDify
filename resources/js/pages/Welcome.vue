...
defineProps({
  logs: Array, // Recebe os logs enviados pelo Inertia
});
...
<div class="min-h-screen bg-gray-100 p-6">
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-6">
      ...
      <h2 class="text-xl font-semibold text-gray-600 mb-3">Logs Recentes</h2>

      <div class="bg-gray-50 p-4 rounded-lg shadow">
        <ul class="divide-y divide-gray-300">
          <li v-for="log in logs" :key="log.id" class="py-2 px-3">
            <span class="text-gray-700 font-medium">{{ log.message }}</span>
            <span class="block text-sm text-gray-500">{{ new Date(log.created_at).toLocaleString() }}</span>
          </li>
        </ul>
      </div>
    </div>
